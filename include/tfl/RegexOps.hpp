...
namespace tfl {
    ...
    inline bool is_empty(Regex<T> const& r) {
        return r.match(matchers::regex::is_empty<T>);
    }
    ...
    inline bool is_epsilon(Regex<T> const& r) {
        return r.match(matchers::regex::is_epsilon<T>);
    }
    ...
    inline bool is_alphabet(Regex<T> const& r) {
        return r.match(matchers::regex::is_alphabet<T>);
    }
    ...
    inline bool is_kleene_star(Regex<T> const& r) {
        return r.match(matchers::regex::is_kleene_star<T>);
    }
    ...
    inline bool is_complement(Regex<T> const& r) {
        return r.match(matchers::regex::is_complement<T>);
    }
    ...
    inline bool is_any(Regex<T> const& r) {
        return r.match(matchers::regex::is_any<T>);
    }
    ///@}
    ...
    inline bool is_nullable(Regex<T> const& r) {
        return r.match(matchers::regex::nullability_checker<T, Eq>);
    }
    ...
    R generate_minimal_alphabet(Regex<T> const& regex) {
        return regex.match(matchers::regex::alphabet_finder<T, R>);
    }
    ...
    inline Regex<T> derive(T const& x, Regex<T> const& regex) {
        return regex.match(matchers::regex::Deriver<T, Eq>{x});
    }
    ...
    inline std::string to_string(Regex<T> const& regex) {
        return regex.match(matchers::regex::printer<T, Stringify>).first;
    }
    ...
    std::size_t depth(Regex<T> const& regex) {
        return regex.match(matchers::regex::depth_probe<T>);
    }
    ...
    std::size_t size(Regex<T> const& regex) {
        return regex.match(matchers::regex::measurer<T>);
    }
    ///@}
}